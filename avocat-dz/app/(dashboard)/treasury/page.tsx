...
export default function FeesPage(){
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display font-extrabold text-2xl flex items-center gap-2"><Wallet className="text-[#0e7490]" /> {t("nav.treasury")} — مثل صندوق المحل</h1>
        <p className="text-sm text-slate-500">مداخيل الأتعاب، المصاريف، والمتبقي — كل الخزينة في مكان واحد</p>
      </div>
